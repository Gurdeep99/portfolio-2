...
export default function Contact1() {
  const data = {
    title: "Get in touch",
    subtitle:
      "I'm always excited to take on new projects and collaborate with innovative minds. If you have a project in mind or just want to chat about design, feel free to reach out!",
    backgroundText: "gurdeep singh",
    social: [
      {
        icon: "ri-phone-fill",
        iconText: "Phone Number",
        link: "8979088240",
        slug: "tel:+91 8979088240",
      },
      {
        icon: "ri-mail-fill",
        iconText: "Email",
        link: "grdp99@gmail.com",
        slug: "mailto:grdp99@gmail.com",
      },
      {
        icon: "ri-github-fill",
        iconText: "Github",
        link: "Gurdeep99",
        slug: "https://github.com/Gurdeep99",
      },
      {
        icon: "ri-map-2-fill",
        iconText: "Address",
        link: "Greater Noida",
        slug: "https://maps.google.com/maps?q=1st+avenue,New+York",
      },
	  {
        icon: "ri-map-2-fill",
        iconText: "Address",
          ...
          <div className="row mt-8">
            <div className="col-lg-4 d-flex flex-column">
              {data.social.map((item, index) => (
                <div className="d-flex align-items-center mb-4 position-relative d-inline-flex" key={index}>
                  <div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
                    <i className={`${item.icon} text-primary-1 fs-26`} />
                  </div>
                  <div className="ps-3">
                    <span className="text-400 fs-5">{item.iconText}</span>
                    <h6 className="mb-0">{item.link}</h6>
                  </div>
                  <Link
                    href={item.slug}
