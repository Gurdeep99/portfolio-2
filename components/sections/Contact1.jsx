			...
			<section id="contact" className="section-contact-1 bg-900 position-relative pt-150 pb-lg-250 pb-150 overflow-hidden">
						...
						<div className="col-lg-4 d-flex flex-column">
							<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								...
								<div className="ps-3">
									...
									<h6 className="mb-0">+91 8979088240</h6>
								</div>
								<Link href="/tel:+91 8979088240" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								<div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
								...
								<div className="ps-3">
									...
									<h6 className="mb-0">grdp99@gmail.com</h6>
								</div>
								<Link href="/mailto:grdp99@gmail.com" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								<div className="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4">
									<i className="ri-github-line text-primary-1 fs-26" />
								</div>
								<div className="ps-3">
									<span className="text-400 fs-5">Github</span>
									<h6 className="mb-0">Gurdeep99</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
								...
								<div className="ps-3">
									...
									<h6 className="mb-0">Greater Noida</h6>
								</div>
									...
									<form action="#">
										<div className="row mt-3">
											...
											<div className="col-md-6">
												...
												<input type="text" className="form-control border rounded-3" id="phone" name="phone" placeholder="+91 234 567 89" aria-label="phone" />
											</div>
											<div className="col-md-6">
				...
				<div className="scroll-move-right position-absolute bottom-0 start-50 translate-middle-x bg-900 overflow-hidden">
					<div className="wow img-custom-anim-top">
						<h3 className="stroke fs-280 text-lowercase text-900 mb-0 lh-1">Gurdeep Singh</h3>
					</div>
				</div>
			</section>
