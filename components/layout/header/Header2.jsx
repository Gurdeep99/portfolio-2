...
export default function Header2({ scroll, isMobileMenu, handleMobileMenu,isOffCanvas, handleOffCanvas }) {
    return (
        <>
            <header>
						...
						<nav className="navbar navbar-expand-lg navbar-home-2 flex-nowrap z-999 p-0 border border-1 rounded-3">
							...
							<div className="container py-3 px-4">
								<Link className="navbar-brand d-flex main-logo align-items-center" href="/index-2">
									<img src="assets/imgs/home-page-2/template/favicon.svg" alt="Gurdeep" />
									<span className="fs-4 ms-2">PORTFOLIO</span>
								</Link>
