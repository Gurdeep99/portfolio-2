...
export default function Header3({ scroll, isMobileMenu, handleMobileMenu,isOffCanvas, handleOffCanvas }) {
	return (
		<>
			<header>
				<nav className="navbar navbar-expand-lg navbar-home-3 flex-nowrap z-999 p-0">
					<div className="container py-3 px-0">
						<Link className="navbar-brand d-flex main-logo align-items-center ms-lg-0 ms-md-5 ms-3" href="/index-3">
							<h1 className="fs-28 mb-0 me-2">PORTFOLIO</h1>
							<img src="assets/imgs/home-page-3/template/favicon.svg" alt="Gurdeep" />
						</Link>
