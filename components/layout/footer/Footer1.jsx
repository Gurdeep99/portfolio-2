				...
				<div className="section-footer position-relative pt-60 pb-60 bg-secondary-1">
					<div className="container position-relative z-1">
						<div className="text-center">
							<Link className="d-flex main-logo align-items-center d-inline-flex" href="https://gurdeep.net">
								<img src="/assets/imgs/footer-1/logo.svg" alt="infinia" />
								<span className="fs-4 ms-2 text-white-keep">Gurdeep.net</span>
							</Link>
						...
						<div className="row text-center py-4">
							<span className="fs-6 text-white-keep">© {new Date().getFullYear()} All Rights Reserved by <span><Link href="https://gurdeep.net" className="text-primary-1">www.Gurdeep.net</Link></span>
							</span></div>
					</div>
