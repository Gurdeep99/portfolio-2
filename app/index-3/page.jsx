						...
						<div className="row">
							<div className="col-lg-4 offset-lg-1">
								<div className="position-relative d-inline-block">
									<img className="rounded-5" src="assets/imgs/home-page-3/hero/img-1.png" alt="Gurdeep" />
									<img className="position-absolute top-100 start-50 translate-middle pt-8 z-0" src="assets/imgs/home-page-3/hero/signature.png" alt="Gurdeep" />
								</div>
								<div className="d-flex flex-column gap-2 mt-9 position-relative z-1">
									<Link href="tel:+12345678901">
										...
										<span className="text-300 fs-6 ms-2">+91 8979088240</span>
									</Link>
											...
											<div className="card-scroll">
												<div className="cards">
													<div className="card-custom pt-0" data-index={0}>
														<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
															<div className="card__image-container rounded-0 zoom-img position-relative">
																<img className="card__image" src="assets/imgs/home-page-3/typical/img-1.png" alt="Gurdeep" />
													...
													<div className="card-custom pt-0" data-index={1}>
														<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
															<div className="card__image-container rounded-0 zoom-img position-relative">
																<img className="card__image" src="assets/imgs/home-page-3/typical/img-2.png" alt="Gurdeep" />
																<Link href="@@link" className="card-image-overlay position-absolute start-0 end-0 w-100 h-100" />
															</div>
															<div className="card__content px-md-4 px-3 pt-lg-0 pb-lg-8 pb-5">
																<div className="card__title mb-0 mb-lg-2">
													...
													<div className="card-custom pt-0" data-index={2}>
														<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
															<div className="card__image-container rounded-0 zoom-img position-relative">
																<img className="card__image" src="assets/imgs/home-page-3/typical/img-3.png" alt="Gurdeep" />
																<Link href="@@link" className="card-image-overlay position-absolute start-0 end-0 w-100 h-100" />
															</div>
															<div className="card__content px-md-4 px-3 pt-lg-0 pb-lg-8 pb-5">
																<div className="card__title mb-0 mb-lg-2">
												...
												<SwiperSlide>
													<div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 mb-3">
														...
														<div className="d-flex align-items-center gap-5">
															...
															<div className="image-right">
																<img className="rounded-3 w-100 h-100" src="assets/imgs/home-page-3/blog/img-1.png" alt="Gurdeep" />
															</div>
														</div>
													</div>
													<div className="card-services rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3">
														...
														<div className="d-flex align-items-center gap-5">
															...
															<div className="image-right">
																<img className="rounded-3 w-100 h-100" src="assets/imgs/home-page-3/blog/img-2.png" alt="Gurdeep" />
															</div>
														</div>
													</div>
												</SwiperSlide>
